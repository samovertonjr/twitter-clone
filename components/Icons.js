export function HomeIcon({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`fill-current stroke-current stroke-0 p-px w-7 h-7 text-blue-500 ${className}`}
    >
      <g>
...
export function HomeIconEmpty({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`fill-current stroke-current stroke-0 p-px w-7 h-7 text-gray-500 ${className}`}
    >
      <g>
